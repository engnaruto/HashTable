...
public class test {
	...
	public static void main(String[] args) {
		...
		HashTable<Integer, String> bHashTable = new BucketingHashTable<Integer, String>();
		...
		HashTable<Integer, String> lpHashTable = new LinearProbingHashTable<Integer, String>();
		hashTableTest(lpHashTable);
		System.out.println("Quadratic Probing HashTable Test");
		HashTable<Integer, String> qpHashTable = new QuadraticProbingHashTable<Integer, String>();
		hashTableTest(qpHashTable);
		System.out.println("Pseudo Random Probing HashTable Test");
		HashTable<Integer, String> prpHashTable = new PseudoRandomProbingHashTable<Integer, String>();
		hashTableTest(prpHashTable);
		System.out.println("Double Hashing HashTable Test");
		HashTable<Integer, String> dhHashTable = new DoubleHashingHashTable<Integer, String>();
